...
// CRUD TINDAKAN
export function listTindakanPagination(pageIndex = 1, pageSize = pageSizeEnv, textSearch = "", newObj = {}) {
    return axiosAuth.get(paramPaging("/tindakan", pageIndex, pageSize, textSearch, newObj));
}

export function APIstoreTindakan(data) {
    return axiosAuth.post("/tindakan", data);
}
